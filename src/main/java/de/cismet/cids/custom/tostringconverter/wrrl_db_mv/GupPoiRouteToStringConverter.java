 ...
 */
public class GupPoiRouteToStringConverter extends CustomToStringConverter {
    ...
    public String createString() {
        ...
        if (!isStringNull(routenname) && !isStringNull(start) && !isStringNull(end)) {
            return "Unterhaltungshinweise: " + routenname + " [" + start + "-" + end + "]";
        } else {
            return "Unterhaltungshinweise: unbekannt";
        }
    }
